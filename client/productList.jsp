...
@
keyframes zoomBanner {from { transform:scale(1);
...
<body>
	...
	<!-- HERO BANNER -->
	 <div class="hero-container"> <div class="hero-bg"></div>
		<div class="hero-content"> <h1>SPORT STORE</h1> <p>BORN TO WIN</p> </div>
		<!-- CATEGORY LEFT -->
	<div class="col-md-3">
		...
		<select class="form-select" onchange="location=this.value">
			...
			<option value="${root}/productList"
				<c:if test="${empty param.categoryId}">selected</c:if>>Tất
				cả danh mục</option>
		...
		<nav>
			...
			<ul class="pagination">
				...
				<c:forEach begin="1" end="${totalPage}" var="i">
					...
					<li class="page-item ${i == pageIndex ? 'active' : ''}"><a
						class="page-link"
	...
	<jsp:include page="footer.jsp" /> <script
