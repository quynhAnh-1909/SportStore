...
public class NotificationDAO {
    ...
    public boolean insertNotification(int userId, String title, String content, String linkUrl) {
        String sql = "INSERT INTO notifications (user_id, title, content, link_url, is_read, created_at) " +
                "VALUES (?, ?, ?, ?, 0, NOW())";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
