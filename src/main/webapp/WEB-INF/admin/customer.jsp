...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // Tìm tất cả các nút có class btn-delete-customer
    const deleteButtons = document.querySelectorAll('.btn-delete-customer');

    deleteButtons.forEach(button => {
      button.addEventListener('click', function(e) {
        e.preventDefault(); // Ngăn chặn việc nhảy trang ngay lập tức
        ...
        Swal.fire({
          ...
          // Nếu Admin bấm "Đồng ý"
          if (result.isConfirmed) {
            // Chuyển hướng tới link xử lý xóa
